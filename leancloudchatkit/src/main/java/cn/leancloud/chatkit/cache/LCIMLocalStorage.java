...
class LCIMLocalStorage extends SQLiteOpenHelper {
    ...
    public LCIMLocalStorage(Context context, String clientId, String tableName) {
        ...
        fromScratch = checkTableExistsSync(this.tableName)&&checkTableHasData(this.tableName);
        createTable();
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        // db.execSQL(String.format(SQL_DROP_TABLE, "ProfileCache"));
        // onCreate(db);
    }
    ...
    private boolean checkTableExistsSync(String tableName) {
