...
public class LCIMClientEventHandler extends AVIMClientEventHandler {
    ...
    private OnClientOfflineListener onClientOfflineListener;
    ...
    public void onClientOffline(AVIMClient avimClient, int i) {
        if (onClientOfflineListener != null) {
            onClientOfflineListener.onClientOffline(avimClient, i);
        }

        setConnectAndNotify(false);
    }

    public void setOnClientOfflineListener(OnClientOfflineListener listener) {
        this.onClientOfflineListener = listener;
    }

    public interface OnClientOfflineListener {
        void onClientOffline(AVIMClient avimClient, int errCode);
    }
}
