...
/**
 * Created by lalo on 2016/11/11.
 */
public class PullToRefreshHorizontalRecycleView extends PullToRefreshBase<RecyclerView> {

    public PullToRefreshHorizontalRecycleView(Context context, Mode mode) {
        super(context, mode);
    }
    ...
    public PullToRefreshHorizontalRecycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshHorizontalRecycleView(Context context, Mode mode, AnimationStyle animStyle) {
