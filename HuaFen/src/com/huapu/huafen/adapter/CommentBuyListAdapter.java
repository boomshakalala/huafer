 ...
 */
public class CommentBuyListAdapter extends CommonWrapper<CommentBuyListAdapter.CommentListHolder> {

    private Context mContext;
    private BaseFragment fragment;
    private List<Comments> mComments = new ArrayList<Comments>();

    public CommentBuyListAdapter(BaseFragment fragment, List<Comments> comments) {
        super();
    ...
    public CommentListHolder onCreateViewHolder(ViewGroup parent, int i) {
        return new CommentListHolder(LayoutInflater.from(mContext).inflate(R.layout.item_comment_list_buy, parent, false));
    }
