 ...
 */
public class CommentListAdapter extends CommonWrapper<CommentListAdapter.CommentListHolder> {
    ...
    public CommentListAdapter(BaseFragment fragment, List<Comments> comments) {
        super();
    ...
    public void setData(List<Comments> comments, long mId) {
        this.mComments = comments;
        this.mId = mId;
    ...
    public CommentListHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        return new CommentListHolder(inflater.inflate(R.layout.item_comment_list, parent, false));
    }
    ...
    public void onBindViewHolder(CommentListHolder commentListHolder, int position) {
        ...
        if (comment.getComment() != null) {
            ...
            commentListHolder.cuvComment.setDataWithId(comment.getComment(), mId);
        } else {
