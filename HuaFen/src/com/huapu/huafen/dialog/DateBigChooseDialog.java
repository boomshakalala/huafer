 ...
 *
 */
public class DateBigChooseDialog extends Dialog implements OnClickListener  {
	...
	public DateBigChooseDialog(Context context, int theme) {
	 ...
	 */
	public DateBigChooseDialog(Context context,String currentDate) {
		super(context, R.style.photo_dialog);
		this.context = context;
...
//		mDay = c.get(Calendar.DAY_OF_MONTH);
	...
	private View intSexView() {
		...
		wvYear.setAdapter(new NumericWheelAdapter(smallYear, (norYear + 1)));
		wvYear.setLabel("年");
