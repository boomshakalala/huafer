 ...
 */
public class GoodListPresenterImpl implements ListPresenter {
    private GoodsListFragment mFragment;
    private UserListModel mModel;
    private int type;

    public GoodListPresenterImpl(GoodsListFragment fragment) {
    ...
    public void getList(final String extra) {
        ...
        OkHttpClientManager.postAsyn(MyConstants.FOLLOWING_GOODS, params, new OkHttpClientManager.StringCallback() {
