...
import com.huapu.huafen.chatim.holder.viewholder.LCIMChatItemAudioHolder;
import com.huapu.huafen.chatim.holder.viewholder.LCIMChatItemHolder;
import com.huapu.huafen.chatim.holder.viewholder.LCIMChatItemImageHolder;
import com.huapu.huafen.chatim.holder.viewholder.LCIMChatItemLocationHolder;
import com.huapu.huafen.chatim.holder.viewholder.LCIMChatItemTextHolder;
...
public class PrivateConversationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PrivateConversationAdapter() {
        super();
    }
    ...
    public int getItemViewType(int position) {
        ...
        LogUtil.e("PrivateConversationAdapter", from);
        if (null != message && message instanceof AVIMTypedMessage) {
            AVIMTypedMessage typedMessage = (AVIMTypedMessage) message;
            // boolean isMe = fromMe(typedMessage);
            boolean isMe = from.equals(CommonPreference.getUserId() + "") ? true : false;
    ...
    private boolean shouldShowTime(int position) {
        ...
        if ((curTime - lastTime) > TIME_INTERVAL) {
            LogUtil.e("LCIMChatAdapterbyGuan", "显示时间" + DateTimeUtils.getMonthDayHourMinute2(lastTime) + "   " + DateTimeUtils.getMonthDayHourMinute2(curTime));
        }
        ;
