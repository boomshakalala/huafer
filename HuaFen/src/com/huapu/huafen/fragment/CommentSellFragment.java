 ...
 */
public class CommentSellFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, CommentSellListFragment.OnCountChangedListener {
    ...
    public static CommentSellFragment newInstance(Bundle bundle) {
        CommentSellFragment commentFragment = new CommentSellFragment();
    ...
    private void initView(View root) {
        ...
        for(int i =0;i<4;i++){
            ...
            CommentSellListFragment listFragment = CommentSellListFragment.newInstance(data);
