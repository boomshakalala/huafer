...
import com.huapu.huafen.adapter.CommentBuyListAdapter;
 ...
 */
public class CommentBuyListFragment extends BaseFragment implements
        PullToRefreshBase.OnRefreshListener<RecyclerView>,LoadMoreWrapper.OnLoadMoreListener {

    private final static String TAG = CommentBuyListFragment.class.getSimpleName();
    ...
    private CommentBuyListAdapter adapter;
    private boolean isFirstRequest = true;
    private HLoadingStateView loadingStateView;
    private int type;
    private int satisfaction;

    public static CommentBuyListFragment newInstance(Bundle bundle) {
        CommentBuyListFragment commentListFragment = new CommentBuyListFragment();
    ...
    private void initRecyclerView(View rootView){
        ...
        adapter = new CommentBuyListAdapter(this,new ArrayList<Comments>());
