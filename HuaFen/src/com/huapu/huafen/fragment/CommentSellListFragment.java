...
import com.huapu.huafen.adapter.CommentSellListAdapter;
 ...
 */
public class CommentSellListFragment extends BaseFragment implements
        PullToRefreshBase.OnRefreshListener<RecyclerView>,LoadMoreWrapper.OnLoadMoreListener {

    private final static String TAG = CommentSellListFragment.class.getSimpleName();
    ...
    private CommentSellListAdapter adapter;
    private boolean isFirstRequest = true;
    private HLoadingStateView loadingStateView;
    private int type;
    private int satisfaction;

    public static CommentSellListFragment newInstance(Bundle bundle) {
        CommentSellListFragment commentListFragment = new CommentSellListFragment();
    ...
    private void initRecyclerView(View rootView){
        ...
        adapter = new CommentSellListAdapter(this,new ArrayList<Comments>());
    ...
    private void startRequestForCommentList(final String extra) {
        ...
        params.put("pageSize", String.valueOf(12));
