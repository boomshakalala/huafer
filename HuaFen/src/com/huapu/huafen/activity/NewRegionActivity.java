 ...
 */
public class NewRegionActivity extends BaseActivity implements
        OnItemClickListener,
    ...
    private BannerData newGoodsBanner = CommonPreference.getNewGoodsBanner();
    ...
    private void initViews() {
        ...
        listAdapter = new CommodityAdapter(NewRegionActivity.this);
    ...
    private void initHeaders() {
        ...
        startRequestForRegions(REFRESH);
    }
    ...
    private void startRequestForRegions(final String extra) {
        ...
        OkHttpClientManager.postAsyn(MyConstants.FULLY_BRANDNEW, params, new OkHttpClientManager.StringCallback() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (baseResult.code == ParserUtils.RESPONSE_SUCCESS_CODE) {
                        ...
                        CommonUtils.error(baseResult, NewRegionActivity.this, "");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void onLoadMoreRequested() {
        startRequestForRegions(LOAD_MORE);
    }
