 ...
 */
@Deprecated
public class FollowListActivity extends BaseActivity implements
    ...
    public void onTitleBarDoubleOnClick() {
        if (ptrRecyclerFollowing != null) {
            ptrRecyclerFollowing.getRefreshableView().scrollToPosition(0);
        }
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (baseResult.code == ParserUtils.RESPONSE_SUCCESS_CODE) {
                        ...
                        CommonUtils.error(baseResult, FollowListActivity.this, "");
                    }
                } catch (Exception e) {
