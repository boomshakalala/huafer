...
public class ScrollableLayout extends LinearLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (updown && shiftY > mTouchSlop && shiftY > shiftX && (!isSticked() || mHelper.isTop() || isClickHeadExpand)) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        maxY = mHeadView.getMeasuredHeight() - titleHeight;
        mHeadHeight = mHeadView.getMeasuredHeight() - titleHeight;
