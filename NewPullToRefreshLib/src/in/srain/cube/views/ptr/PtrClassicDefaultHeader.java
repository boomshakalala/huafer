...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mRotateView.setBackgroundResource(R.drawable.loading1);
    }
...
//        mRotateView.startAnimation(mReverseFlipAnimation);
        mRotateView.setBackgroundResource(R.drawable.anim_loading);
        animation = (AnimationDrawable) mRotateView.getBackground();
        animation.start();
